...
Public Class FrmJefes
    ...
    Sub carga_folio()
        Try
            ...
            sqlfolioDepto.CommandText = ("select distinct folio  from requerimiento  where requerimiento.Id_Depto  ='" & (FrmMenu_Aut_Req_Direccion.Label_Id_Depto.Text) & "'" & "order by folio desc")
    ...
    Sub buscar_folio()
        Try
            ...
            While (sqldrfolio.Read())
                ...
                Else
                    If sqldrfolio("Status_Titular") = "A" And sqldrfolio("Status_Sub_Adm") = "P" Then
                        BtnRechazar.Enabled = True
                        BtnAutoriza.Enabled = False
                    Else
                        If sqldrfolio("Status_Titular") = "R" Then
                            BtnAutoriza.Enabled = True
                        End If
                    End If
    ...
    Sub Autorizar_Requerimiento()
        Try
            ...
            If Autoriza = vbYes Then
                ...
                Dim insal As String = ("UPDATE  Requerimiento SET Status_Titular=@Status_Titular,Fecha_Aut_Titular=@Fecha_Aut_Titular  where  Folio= '" & CBFolio.Text & "'")
    ...
    Sub Rechaza_Requerimiento()
        Try
            ...
            If Autoriza = vbYes Then
                'Dim insal As String = ("INSERT into talumno (matricula,nombre)" & "values(" & TBMatricula.Text & "," & TBNombre.Text & ",")
                Dim insal As String = ("UPDATE  Requerimiento SET Status_Titular=@Status_Titular  where  Folio= '" & CBFolio.Text & "'")
                Dim conex1 As New SqlClient.SqlCommand(insal, Me.SqlConnection1)
