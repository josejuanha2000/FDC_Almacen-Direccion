    ...
    Public Function validar(ByVal dts As Datos2) As Boolean
        Try
            ...
            If dr.HasRows = True Then
                ...
                FrmMenu_Aut_Req_Direccion.TBDepto.Text = dr("Departamento")
                FrmMenu_Aut_Req_Direccion.TBTitular.Text = dr("Titular")
                FrmMenu_Aut_Req_Direccion.Label_Id_Depto.Text = dr("Id_Depto")
