...
Public Class Frm_Req_Mat_Aut_Direccion
    ...
    Private Sub Frm_Req_Mat_Aut_Direccion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TBDepto.Text = FrmMenu_Aut_Req_Direccion.TBDepto.Text
        TBTitular.Text = FrmMenu_Aut_Req_Direccion.TBTitular.Text
        Label_Id_Depto.Text = FrmMenu_Aut_Req_Direccion.Label_Id_Depto.Text
    ...
    Sub limpiar_formulario()
        ...
        Me.NUpDownC1.Value = 0
        Me.NUpDownC2.Value = 0
        Me.NUpDownC3.Value = 0
        Me.NUpDownC4.Value = 0
        Me.NUpDownC5.Value = 0
        Me.NUpDownC6.Value = 0
        Me.NUpDownC7.Value = 0
        Me.NUpDownC8.Value = 0
        Me.NUpDownC9.Value = 0
        Me.NUpDownC10.Value = 0
    ...
    Private Sub CheckBox1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox1.CheckedChanged
        If CheckBox1.Checked = True Then
            ...
            NUpDownC1.Enabled = True
        Else
            req1 = 0
            CBA1.Enabled = False
            TB1.Enabled = False
            NUpDown1.Enabled = False
            NUpDownC1.Enabled = False
        End If
    End Sub
    Private Sub CheckBox2_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox2.CheckedChanged
        If CheckBox2.Checked = True Then
            ...
            NUpDownC2.Enabled = True
        Else
            req2 = 0
            CBA2.Enabled = False
            TB2.Enabled = False
            NUpDown2.Enabled = False
            NUpDownC2.Enabled = False
        End If
    End Sub
    Private Sub CheckBox3_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox3.CheckedChanged
        If CheckBox3.Checked = True Then
            ...
            NUpDownC3.Enabled = True
        Else
            req3 = 0
            CBA3.Enabled = False
            TB3.Enabled = False
            NUpDown3.Enabled = False
            NUpDownC3.Enabled = False
        End If
    End Sub
    Private Sub CheckBox4_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox4.CheckedChanged
        If CheckBox4.Checked = True Then
            ...
            NUpDownC4.Enabled = True
        Else
            req4 = 0
            CBA4.Enabled = False
            TB4.Enabled = False
            NUpDown4.Enabled = False
            NUpDownC4.Enabled = False
        End If
    End Sub
    Private Sub CheckBox5_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox5.CheckedChanged
        If CheckBox5.Checked = True Then
            ...
            NUpDownC5.Enabled = True
        Else
            req5 = 0
            CBA5.Enabled = False
            TB5.Enabled = False
            NUpDown5.Enabled = False
            NUpDownC5.Enabled = False
        End If
    End Sub
    Private Sub CheckBox6_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox6.CheckedChanged
        If CheckBox6.Checked = True Then
            ...
            NUpDownC6.Enabled = True
        Else
            req6 = 0
            CBA6.Enabled = False
            TB6.Enabled = False
            NUpDown6.Enabled = False
            NUpDownC6.Enabled = False
        End If
    End Sub
    Private Sub CheckBox7_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox7.CheckedChanged
        If CheckBox7.Checked = True Then
            ...
            NUpDownC7.Enabled = True
        Else
            req7 = 0
            CBA7.Enabled = False
            TB7.Enabled = False
            NUpDown7.Enabled = False
            NUpDownC7.Enabled = False
        End If
    End Sub
    Private Sub CheckBox8_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox8.CheckedChanged
        If CheckBox8.Checked = True Then
            ...
            NUpDownC8.Enabled = True
        Else
            req8 = 0
            CBA8.Enabled = False
            TB8.Enabled = False
            NUpDown8.Enabled = False
            NUpDownC8.Enabled = False
        End If
    End Sub
    Private Sub CheckBox9_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox9.CheckedChanged
        If CheckBox9.Checked = True Then
            ...
            NUpDownC9.Enabled = True
        Else
            req9 = 0
            CBA9.Enabled = False
            TB9.Enabled = False
            NUpDown9.Enabled = False
            NUpDownC9.Enabled = False
        End If
    End Sub
    Private Sub CheckBox10_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CheckBox10.CheckedChanged
        If CheckBox10.Checked = True Then
            ...
            NUpDownC10.Enabled = True
        Else
            req10 = 0
            CBA10.Enabled = False
            TB10.Enabled = False
            NUpDown10.Enabled = False
            NUpDownC10.Enabled = False
        End If
    End Sub
    ...
    Sub requerimiento1()
        ...
        Try
            Me.SqlConnection1.Open()
            Dim Insar1 As String = "INSERT INTO Requerimiento (Folio,Cve_Pro,Cve_Art,Nombre_Art,Fecha_Cap_Req,Depto,Titular_Depto,Cant_Art,Justificacion,Act,Status_titular,Status_Sub_Adm,Status_Direccion,Fecha_Aut_Titular,Fecha_Aut_Sub_Adm,Fecha_Aut_Direccion,No_Factura,No_Compra,Precio_Unitario,Total_x_Cantidad,IVA,Total_IVA,Status_Entrega,Id_Depto) values(@Folio,@Cve_Pro,@Cve_Art,@Nombre_Art,@Fecha_Cap_Req,@Depto,@Titular_Depto,@Cant_Art,@Justificacion,@Act,@Status_titular,@Status_Sub_Adm,@Status_Direccion,@Fecha_Aut_Titular,@Fecha_Aut_Sub_Adm,@Fecha_Aut_Direccion,@No_Factura,@No_Compra,@Precio_Unitario,@Total_x_Cantidad,@IVA,@Total_IVA,@Status_Entrega,@Id_Depto)"
            ...
            conex1.Parameters.Add(New SqlParameter("@Status_Titular", SqlDbType.NChar, 1)).Value = "A"
            conex1.Parameters.Add(New SqlParameter("@Status_Sub_Adm", SqlDbType.NChar, 1)).Value = "A"
            conex1.Parameters.Add(New SqlParameter("@Status_Direccion", SqlDbType.NChar, 1)).Value = "A"
            ...
            conex1.Parameters.Add(New SqlParameter("@Precio_Unitario", SqlDbType.Decimal, 9)).Value = Me.NUpDownC1.Text
    ...
    Sub requerimiento2()
        Try
            ...
            conex1.Parameters.Add(New SqlParameter("@No_Factura", SqlDbType.NChar, 7)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@No_Compra", SqlDbType.NChar, 5)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@Precio_Unitario", SqlDbType.Decimal, 9)).Value = Me.NUpDownC2.Text
            conex1.Parameters.Add(New SqlParameter("@Total_x_Cantidad", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@IVA", SqlDbType.Int, 4)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Total_IVA", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Status_Entrega", SqlDbType.NChar, 1)).Value = ""
    ...
    Sub requerimiento3()
        Try
            ...
            conex1.Parameters.Add(New SqlParameter("@No_Factura", SqlDbType.NChar, 7)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@No_Compra", SqlDbType.NChar, 5)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@Precio_Unitario", SqlDbType.Decimal, 9)).Value = Me.NUpDownC3.Text
            conex1.Parameters.Add(New SqlParameter("@Total_x_Cantidad", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@IVA", SqlDbType.Int, 4)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Total_IVA", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Status_Entrega", SqlDbType.NChar, 1)).Value = ""
    ...
    Sub requerimiento4()
        Try
            ...
            conex1.Parameters.Add(New SqlParameter("@No_Factura", SqlDbType.NChar, 7)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@No_Compra", SqlDbType.NChar, 5)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@Precio_Unitario", SqlDbType.Decimal, 9)).Value = Me.NUpDownC4.Text
            conex1.Parameters.Add(New SqlParameter("@Total_x_Cantidad", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@IVA", SqlDbType.Int, 4)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Total_IVA", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Status_Entrega", SqlDbType.NChar, 1)).Value = ""
    ...
    Sub requerimiento5()
        Try
            ...
            conex1.Parameters.Add(New SqlParameter("@No_Factura", SqlDbType.NChar, 7)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@No_Compra", SqlDbType.NChar, 5)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@Precio_Unitario", SqlDbType.Decimal, 9)).Value = Me.NUpDownC5.Text
            conex1.Parameters.Add(New SqlParameter("@Total_x_Cantidad", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@IVA", SqlDbType.Int, 4)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Total_IVA", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Status_Entrega", SqlDbType.NChar, 1)).Value = ""
    ...
    Sub requerimiento6()
        Try
            ...
            conex1.Parameters.Add(New SqlParameter("@No_Factura", SqlDbType.NChar, 7)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@No_Compra", SqlDbType.NChar, 5)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@Precio_Unitario", SqlDbType.Decimal, 9)).Value = Me.NUpDownC6.Text
            conex1.Parameters.Add(New SqlParameter("@Total_x_Cantidad", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@IVA", SqlDbType.Int, 4)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Total_IVA", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Status_Entrega", SqlDbType.NChar, 1)).Value = ""
    ...
    Sub requerimiento7()
        Try
            ...
            conex1.Parameters.Add(New SqlParameter("@No_Factura", SqlDbType.NChar, 7)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@No_Compra", SqlDbType.NChar, 5)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@Precio_Unitario", SqlDbType.Decimal, 9)).Value = Me.NUpDownC7.Text
            conex1.Parameters.Add(New SqlParameter("@Total_x_Cantidad", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@IVA", SqlDbType.Int, 4)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Total_IVA", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Status_Entrega", SqlDbType.NChar, 1)).Value = ""
    ...
    Sub requerimiento8()
        Try
            ...
            conex1.Parameters.Add(New SqlParameter("@No_Factura", SqlDbType.NChar, 7)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@No_Compra", SqlDbType.NChar, 5)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@Precio_Unitario", SqlDbType.Decimal, 9)).Value = Me.NUpDownC8.Text
            conex1.Parameters.Add(New SqlParameter("@Total_x_Cantidad", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@IVA", SqlDbType.Int, 4)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Total_IVA", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Status_Entrega", SqlDbType.NChar, 1)).Value = ""
    ...
    Sub requerimiento9()
        Try
            ...
            conex1.Parameters.Add(New SqlParameter("@No_Factura", SqlDbType.NChar, 7)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@No_Compra", SqlDbType.NChar, 5)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@Precio_Unitario", SqlDbType.Decimal, 9)).Value = Me.NUpDownC9.Text
            conex1.Parameters.Add(New SqlParameter("@Total_x_Cantidad", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@IVA", SqlDbType.Int, 4)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Total_IVA", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Status_Entrega", SqlDbType.NChar, 1)).Value = ""
    ...
    Sub requerimiento10()
        Try
            ...
            conex1.Parameters.Add(New SqlParameter("@No_Factura", SqlDbType.NChar, 7)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@No_Compra", SqlDbType.NChar, 5)).Value = ""
            conex1.Parameters.Add(New SqlParameter("@Precio_Unitario", SqlDbType.Decimal, 9)).Value = Me.NUpDownC10.Text
            conex1.Parameters.Add(New SqlParameter("@Total_x_Cantidad", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@IVA", SqlDbType.Int, 4)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Total_IVA", SqlDbType.Decimal, 9)).Value = 0
            conex1.Parameters.Add(New SqlParameter("@Status_Entrega", SqlDbType.NChar, 1)).Value = ""
